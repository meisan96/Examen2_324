    <div class="alert alert-success" role="alert">
		...
		<p>RRegistra al segundo ejecutivo del frente <?php echo $_SESSION['frente'];?>.</p>
		<p class="mb-0">Fecha de Ingreso: <?php echo date("Y-m-d");?></p>
		<hr>
        <center>
		<div class="card" style="width:500px;">
			<div class="card-header">
				REGISTRO DE 2DO EJECUTIVO
			</div>
			<div class="card-body">
...
if (isset($_POST['Registrar'])) {
    $id = $_POST["id"];
    $sql = "UPDATE frente set 2do=$id where sigla='".$_SESSION["frente"]."'";
    $res = mysqli_query($conn, $sql);
    echo '<script language="javascript">alert("Registrado como 2do Ejecutivo.");</script>';
 }   
 ?>